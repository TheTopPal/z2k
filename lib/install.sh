...
TMPJUNK
    ...
    local fallback_url="https://github.com/necronicle/zapret2-z2k/releases/download/v1.0.5.1-z2k-r1/zapret2-v1.0.5.1-z2k-r1-openwrt-embedded.tar.gz"
    local openwrt_url=""

    # Эталон install_bin.sh из ПРИКРЕПЛЁННОГО релиза (v1.0.5.1-z2k-r1; сам файл
