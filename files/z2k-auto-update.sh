...
#
# Кавычки снимаем оба вида. Голая цифра — то, что пишут и генератор конфига, и
# set_flag, но строка может приехать и из чужого бэкапа: install.sh переносит
# сохранённые флаги в новый конфиг ПОСЛОВНО, как они лежали. Значение '0' в
# апострофах здесь читалось как «не ноль», то есть гейт открывался.
...
# утёкший Z2K_AU_NO_JITTER снимал разброс 0..90 мин, и такие роутеры ходили на
